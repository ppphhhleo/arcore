package za.co.fredkobo.arcoreland.arcorelocation.rendering;
...
public class LocationNode extends AnchorNode {
    ...
    private float gradualScalingMaxScale = 2.0F;
    private static int times=0;

    private LocationMarker.ScalingMode scalingMode = LocationMarker.ScalingMode.GRADUAL_FIXED_SIZE;
    ...
    public void onUpdate(FrameTime frameTime) {
        ...
        //ILog.i("LocationScene","anchor x:"+getWorldPosition().x+"  y:"+getWorldPosition().y+"  z:"+getWorldPosition().z+" times:"+(times++));
    ...
    public void scaleAndRotate() {
        for (Node n : getChildren()) {
            ...
            // Prevents za.co.fredkobo.arcorelocationpoc.arcorelocation.rendering issues.
            ...
            //Log.i("LocationScene","Camera:x:"+cameraPosition.x+"  y:"+cameraPosition.y+"  z:"+cameraPosition.z+"  node:x:"+n.getWorldPosition().x+"  y:"+n.getWorldPosition().y+"  z:"+n.getWorldPosition().z);
            ...
            switch (scalingMode) {
                case FIXED_SIZE_ON_SCREEN:
                    ...
                    break;
                case GRADUAL_TO_MAX_RENDER_DISTANCE:   //the closer to the destination,the bigger the label is
                    ...
                    break;
                case GRADUAL_FIXED_SIZE:    //the closer to the destination,the bigger the label is
                    scale = (float) Math.sqrt(direction.x * direction.x
                            + direction.y * direction.y + direction.z * direction.z);
